...
public class MscpService {
  ...
  public List<Mscp> mscpSeed() {
    ...
    mscpRepository
        .save(new Mscp("576A", "Hougang Ave 4", 531576, "531576", getCarplate(531576, 0), getCarplate(531576, 1),
    ...
    mscpRepository
        .save(new Mscp("282", "Bishan Street 22", 570282, "570282", getCarplate(570282, 0), getCarplate(570282, 1),
            getCarplate(570282, 2), getCarplate(570282, 3), 1.359043179540605, 103.8446510020644));
    mscpRepository
        .save(new Mscp("773", "Yishun Avenue 3", 760773, "760773", getCarplate(760773, 0), getCarplate(760773, 1),
    ...
    mscpRepository
        .save(
            new Mscp("170", "Upper Bukit Timah Road", 588179, "588179", getCarplate(588179, 0), getCarplate(588179, 1),
                getCarplate(588179, 2), getCarplate(588179, 3), 1.3443085606141671, 103.77574717187827));
    mscpRepository
    ...
    mscpRepository
        .save(new Mscp("650", "Punggol Central", 820650, "820650", getCarplate(820650, 0), getCarplate(820650, 1),
            getCarplate(820650, 2), getCarplate(820650, 3), 1.3978391654943176, 103.91537466501215));
    mscpRepository
        .save(new Mscp("257A", "Pasir Ris Street 21", 515257, "515257", getCarplate(515257, 0), getCarplate(515257, 1),
    ...
    mscpRepository
        .save(new Mscp("116", "Jurong East Street 13", 600116, "600116", getCarplate(600116, 0), getCarplate(600116, 1),
            getCarplate(600116, 2), getCarplate(600116, 3), 1.3404581856076383, 103.73459183345581));
    mscpRepository
        .save(new Mscp("986", "Jurong West Street 93", 640986, "640986", getCarplate(640986, 0), getCarplate(640986, 1),
            getCarplate(640986, 2), getCarplate(640986, 3), 1.3379068975947601, 103.69469166542449));
    mscpRepository
        .save(new Mscp("358A", "Woodlands Avenue 5", 731358, "731358", getCarplate(731358, 0), getCarplate(731358, 1),
            getCarplate(731358, 2), getCarplate(731358, 3), 1.4340074973187484, 103.78382517024738));
    mscpRepository
        .save(new Mscp("855", "Yishun Ring Road", 760855, "760855", getCarplate(760855, 0), getCarplate(760855, 1),
            getCarplate(760855, 2), getCarplate(760855, 3), 1.4183100374602229, 103.83650525730681));
    mscpRepository
        .save(
            new Mscp("323", "Sengkang East Way", 543323, "543323", getCarplate(543323, 0), getCarplate(543323, 1),
